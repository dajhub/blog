...
### Rotate an application around the current desktop
    super + shift + {p,o}
...
If needed, my configuration file can be found on my [GitHub](https://github.com/dajhub/dotfiles/tree/master/BSPWM/sxhk) page.
